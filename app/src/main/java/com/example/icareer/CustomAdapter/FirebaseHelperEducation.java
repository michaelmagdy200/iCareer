...
public class FirebaseHelperEducation {
    DatabaseReference db , reference ;
    Boolean saved=null;
    ArrayList<JobSeekerClass> educations =new ArrayList<>();

    public FirebaseHelperEducation(DatabaseReference db) {
        this.db = db;
    }
                ...
                db.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds : snapshot.getChildren()){
                            ...
                            reference.child("Education").push().setValue(jobSeekerClass);
                        }
                    }
