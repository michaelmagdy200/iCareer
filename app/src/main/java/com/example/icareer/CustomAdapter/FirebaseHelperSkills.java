...
public class FirebaseHelperSkills {
    DatabaseReference db , reference ;
    Boolean saved=null;
    ArrayList<JobSeekerClass> skills =new ArrayList<>();

    public FirebaseHelperSkills(DatabaseReference db) {
        this.db = db;
    }
                ...
                db.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds : snapshot.getChildren()){
                            ...
                            reference.child("Skills").push().setValue(jobSeekerClass);
                        }
                    }
